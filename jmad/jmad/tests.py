...
class StudentTestCase(LiveServerTestCase):
    ...
    def setUp(self):
        ...
        self.solo1 = Solo.objects.create(instrument='saxophone', artist='Coltrane', track='My Favorite Things')
    ...
    def test_student_find_solos(self):
        ...
        # Steve wants to go back to another tune he saw in the search results. He types the name of the tune directly
        # into the search box.

        # He sees the track title and clicks on it
